...
*/
#include<iostream>
#include<cmath> // added this library to use predefined functions
using namespace std;
const float G = 9.8f;
...
return weight*pow(speed,2)/2 ; // used pow function instead of speed*speed
}
        ...
        case 4:
          ...
          result = getWork(weight,distance);
           cout<<"Work = "<<result<<" J"<<endl;
              break; 
        case 5: // changed this case to 5 for exiting program
                cout << "Exiting program" << endl;
                break;
        default:
                cout << "Invalid choice" << endl;   
       }
           } while (choice <=4); // changed this condition to 4
